...
The result of your task is the program with the verifiable specifications
inserted.  You should also comment each function with the exact command you ran
to verify it.
