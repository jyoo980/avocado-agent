...
__CPROVER_requires(__CPROVER_is_fresh(Red, sizeof(*Red)))
__CPROVER_requires(__CPROVER_is_fresh(Green, sizeof(*Green)))
__CPROVER_requires(__CPROVER_is_fresh(Blue, sizeof(*Blue)))
...
__CPROVER_requires(__CPROVER_is_fresh(G, sizeof(*G)))
