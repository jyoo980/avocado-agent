...
__CPROVER_requires(__CPROVER_is_fresh(bs, sizeof(*bs)))
__CPROVER_requires(bs->limit >= 0 && bs->limit <= 2048)
__CPROVER_requires(bs->pos >= 0 && bs->pos <= bs->limit)
__CPROVER_requires(__CPROVER_is_fresh(bs->buf, 2048))
__CPROVER_requires(__CPROVER_is_fresh(gr, sizeof(L3_gr_info_t) * 4))
__CPROVER_requires(__CPROVER_is_fresh(hdr, 4))
