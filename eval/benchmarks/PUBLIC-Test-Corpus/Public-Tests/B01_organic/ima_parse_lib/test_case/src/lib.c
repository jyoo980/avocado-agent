...
__CPROVER_assigns()
__CPROVER_ensures(__CPROVER_return_value == (ima_u16_t)(((v & 0x00ffu) << 8) | ((v & 0xff00u) >> 8)))
{
...
__CPROVER_assigns()
__CPROVER_ensures(__CPROVER_return_value == (((v & 0x000000fful) << 24) | ((v & 0x0000ff00ul) << 8) | ((v & 0x00ff0000ul) >> 8) | ((v & 0xff000000ul) >> 24)))
{
...
__CPROVER_requires(__CPROVER_is_fresh(data, 4096))
