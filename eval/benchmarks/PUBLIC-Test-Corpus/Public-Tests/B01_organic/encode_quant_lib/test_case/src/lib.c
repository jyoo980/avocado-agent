...
int encode_quant(int uni, int step, int pred, int tgt, int tgt2, int lsbit)
    __CPROVER_requires(uni >= -1000 && uni <= 1000)
    __CPROVER_requires(step >= 0 && step <= 1000)
    __CPROVER_requires(pred >= -1000000 && pred <= 1000000)
    __CPROVER_requires(tgt >= -1000000 && tgt <= 1000000)
    __CPROVER_requires(tgt2 >= -1000000 && tgt2 <= 1000000)
    __CPROVER_requires(lsbit >= 0 && lsbit <= 4)
    __CPROVER_assigns()
    __CPROVER_ensures(__CPROVER_return_value >= uni - 2 && __CPROVER_return_value <= uni + 2)
{
    int uni1, uni2;
