...
__CPROVER_requires(__CPROVER_is_fresh(h, 3 * sizeof(*h)))
__CPROVER_assigns()
...
__CPROVER_requires(__CPROVER_is_fresh(h1, 3 * sizeof(*h1)))
__CPROVER_requires(__CPROVER_is_fresh(h2, 3 * sizeof(*h2)))
__CPROVER_assigns()
__CPROVER_ensures(__CPROVER_return_value == 0 || __CPROVER_return_value == 1)
{
