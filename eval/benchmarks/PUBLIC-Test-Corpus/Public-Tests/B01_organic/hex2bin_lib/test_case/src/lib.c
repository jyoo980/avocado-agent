...
__CPROVER_requires(hex_len <= 8)
__CPROVER_requires(bin_maxlen <= 8)
__CPROVER_requires(__CPROVER_is_fresh(hex, hex_len + 1))
__CPROVER_requires(__CPROVER_is_fresh(bin, bin_maxlen))
__CPROVER_requires(__CPROVER_pointer_equals(ignore, (void *)0))
__CPROVER_requires(__CPROVER_pointer_equals(hex_end_p, (void *)0))
