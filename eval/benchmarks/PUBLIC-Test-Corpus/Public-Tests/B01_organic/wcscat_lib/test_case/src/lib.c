...
__CPROVER_requires(__CPROVER_is_fresh(dst, numElem * sizeof(*dst)))
__CPROVER_requires(__CPROVER_is_fresh(src, numElem * sizeof(*src)))
__CPROVER_assigns(__CPROVER_object_upto(dst, numElem * sizeof(*dst)))
