...
static void spritebatch_internal_merge_sort_iteration(spritebatch_sprite_t *a, int lo,
                                               int split, int hi,
                                               spritebatch_sprite_t *b)
__CPROVER_requires(0 <= lo && lo <= split && split <= hi && hi <= 8)
__CPROVER_requires(__CPROVER_is_fresh(a, hi * sizeof(*a)))
__CPROVER_requires(__CPROVER_is_fresh(b, hi * sizeof(*b)))
...
__CPROVER_requires(0 <= lo && lo <= hi && hi <= 8)
__CPROVER_requires(__CPROVER_is_fresh(a, hi * sizeof(*a)))
__CPROVER_requires(__CPROVER_is_fresh(b, hi * sizeof(*b)))
...
__CPROVER_requires(0 <= size && size <= 8)
__CPROVER_requires(__CPROVER_is_fresh(a, size * sizeof(*a)))
__CPROVER_requires(__CPROVER_is_fresh(b, size * sizeof(*b)))
__CPROVER_assigns(__CPROVER_object_whole(a), __CPROVER_object_whole(b))
{
