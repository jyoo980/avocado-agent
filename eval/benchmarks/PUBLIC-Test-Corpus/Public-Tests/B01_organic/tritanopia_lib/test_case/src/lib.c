...
static cb_rgb cbNorm(cb_rgb_255 RGB)
    __CPROVER_assigns()
    __CPROVER_ensures(__CPROVER_return_value.R == (float)(RGB.R) / 255.f)
    __CPROVER_ensures(__CPROVER_return_value.G == (float)(RGB.G) / 255.f)
    __CPROVER_ensures(__CPROVER_return_value.B == (float)(RGB.B) / 255.f)
{
