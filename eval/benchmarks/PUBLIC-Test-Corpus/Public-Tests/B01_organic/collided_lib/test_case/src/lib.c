...
c2v c2V(float x, float y)
    __CPROVER_assigns()
    __CPROVER_ensures((__CPROVER_return_value.x == x) || (x != x))
    __CPROVER_ensures((__CPROVER_return_value.y == y) || (y != y))
{
    c2v a;
    a.x = x;
    a.y = y;
...
c2v c2Maxv(c2v a, c2v b)
    __CPROVER_assigns()
    __CPROVER_ensures(__CPROVER_return_value.x == (a.x > b.x ? a.x : b.x))
    __CPROVER_ensures(__CPROVER_return_value.y == (a.y > b.y ? a.y : b.y))
{
...
c2v c2Sub(c2v a, c2v b)
    __CPROVER_assigns()
    __CPROVER_ensures((__CPROVER_return_value.x == a.x - b.x) || (a.x - b.x != a.x - b.x))
    __CPROVER_ensures((__CPROVER_return_value.y == a.y - b.y) || (a.y - b.y != a.y - b.y))
{
    a.x -= b.x;
    a.y -= b.y;
    return a;
