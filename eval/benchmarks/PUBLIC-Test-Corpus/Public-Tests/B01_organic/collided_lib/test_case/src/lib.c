...
__CPROVER_requires(typeA == C2_TYPE_CIRCLE || typeA == C2_TYPE_AABB)
__CPROVER_requires(typeB == C2_TYPE_CIRCLE || typeB == C2_TYPE_AABB)
__CPROVER_requires(__CPROVER_is_fresh(A, sizeof(c2Circle) >= sizeof(c2AABB) ? sizeof(c2Circle) : sizeof(c2AABB)))
__CPROVER_requires(__CPROVER_is_fresh(B, sizeof(c2Circle) >= sizeof(c2AABB) ? sizeof(c2Circle) : sizeof(c2AABB)))
__CPROVER_assigns()
__CPROVER_ensures(__CPROVER_return_value == 0 || __CPROVER_return_value == 1)
{
    switch (typeA) {
