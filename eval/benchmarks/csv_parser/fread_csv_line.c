...
__CPROVER_requires(max_line_size > 0 && max_line_size < 1024)
__CPROVER_requires(__CPROVER_is_fresh(fp, sizeof(FILE)))
__CPROVER_requires(__CPROVER_is_fresh(done, sizeof(int)))
__CPROVER_requires(__CPROVER_is_fresh(err, sizeof(int)))
{
