// From: https://github.com/semitrivial/csv_parser/blob/master/csv.c
...
__CPROVER_requires(__CPROVER_is_fresh(line, 6))
__CPROVER_ensures(__CPROVER_return_value == -1 || (__CPROVER_return_value >= 1 && __CPROVER_return_value <= 100))
__CPROVER_assigns()
{
    const char *ptr;
    int cnt, fQuote;
