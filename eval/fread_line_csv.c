...
__CPROVER_requires(__CPROVER_is_fresh(fp, sizeof(*fp)))
__CPROVER_requires(__CPROVER_is_fresh(done, sizeof(*done)))
__CPROVER_requires(__CPROVER_is_fresh(err, sizeof(*err)))
__CPROVER_requires(max_line_size > 0)
__CPROVER_requires(max_line_size < 1024)
__CPROVER_assigns(*done, *err)
{
