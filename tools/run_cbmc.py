...
def _run_pipeline(
    ...
    to its logical step. Step records are appended to `subprocess_results` for the JSONL log.
    ...
    Args:
        ...
        subprocess_results (list[dict]): Mutated in place — one record per subprocess invocation
